...
import rent.my.car.plugins.AccessDeniedException
import rent.my.car.plugins.InvalidUpdateMeException
import io.ktor.http.*
...
fun Route.userProfileRouting() {
    authenticate() {
        ...
        get("/userprofile") {
            ...
            val userType =
                UserType.valueOf(principal?.payload?.getClaim("userType")?.asString() ?: UserType.CLIENT.name)
