...
object UserDatabase {
    val users = mutableMapOf(
        1 to User("Vincent", "vincent@gmail.com", "password1", Role.OWNER, 1, DrivingBehavior.GOOD),
        2 to User("Kayal", "Kayal@gmail.com", "password2", Role.OWNER, 2, DrivingBehavior.BAD),
        ...
        5 to User("Herman", "Herman@gmail.com", "password5", Role.OWNER, 5, DrivingBehavior.BAD),
        ...
        8 to User("Jill", "Jill@gmail.com", "password8", Role.OWNER, 8, DrivingBehavior.BAD),
