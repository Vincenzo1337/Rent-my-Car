...
object CarDatabase {
    val cars = mutableMapOf(
        1 to Car(null, "BMW", "E30", CarCategory.ICE, true, listOf(TimeBlock(startTime = 1000, endTime = 1000)), "De BMW E30 is een populaire keuze vanwege zijn sportieve uitstraling, betrouwbare prestaties en tijdloze ontwerp.", UserDatabase.users[1]!!.id, null, location = Location(51.560596, 5.091914)),
